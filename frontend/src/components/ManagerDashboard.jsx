...
<button
  onClick={() => {
    fetch(`https://goal-tracker-backend-lzkr.onrender.com/api/goals/${goal.id}/comment`, {
      method: "PUT",
      headers: {
...
>
  Save Comment
              ...
              <div className="mt-4 flex gap-3">
                <button
                    onClick={() => {
                       fetch(`https://goal-tracker-backend-lzkr.onrender.com/api/goals/${goal.id}/approve`, {
                        method: "PUT",
                       })
                            .then((response) => response.json())
                            .then((data) => {
                ...
                <button
  onClick={() => {
    fetch(`https://goal-tracker-backend-lzkr.onrender.com/api/goals/${goal.id}/return`, {
      method: "PUT",
    })
      .then((response) => response.json())
      .then((data) => {
